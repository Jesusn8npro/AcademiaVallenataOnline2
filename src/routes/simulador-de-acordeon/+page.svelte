<script>
    ...
    import { sleep } from '$lib/SimuladorDeAcordeonJS/utilidadesSimulador.js';
    import { mapaTeclas, tono } from '$lib/SimuladorDeAcordeonJS/mapaTecladoYFrecuencias.js';
    import {
      mapaTeclasBajos,
      disposicion,
      disposicionBajos,
      ...
      cambiarFuelle,
      escalas
    } from '$lib/SimuladorDeAcordeonJS/notasAcordeonDiatonico.js';
