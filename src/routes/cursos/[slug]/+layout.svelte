<script lang="ts">
  ...
  onMount(() => {
    console.log('🎯 [CURSO DETALLE] Configurando página sin menús');
    ...
    function ocultarElementosNavegacion() {
      ...
      console.log('✅ [CURSO DETALLE] Elementos de navegación ocultados');
    }
  ...
  onDestroy(() => {
    if (observer) {
      observer.disconnect();
      console.log('🧹 [CURSO DETALLE] Observer desconectado');
    }
  });
</script>
...
<main class="curso-detalle-container">
  <slot />
</main>
